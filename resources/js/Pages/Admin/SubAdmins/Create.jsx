...
export default function Create() {
  ...
  const handleSubmit = e => {
    e.preventDefault()
    post(route('admin.sub-admins.store'))
  }


  return (
    <>
      <Head title={t('subadmin.create_title')} />
      <Box sx={{ py: 4 }}>
          ...
          <Paper sx={{
            ...
            <form onSubmit={handleSubmit}>
              ...
              <Box sx={{
                ...
                <Link href={route('admin.sub-admins.index')}>
                  <Button
                    variant='outlined'
                    sx={{
