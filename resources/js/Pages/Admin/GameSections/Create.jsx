...
export default function Create({ sectionTypes }) {
  ...
  const submit = e => {
    ...
    router.post(route('admin.game-sections.store'), formData, {
      onSuccess: () => {
        reset()
  ...
  return (
    <>
      <Head title={t('game_sections.create')} />
      <Box sx={{ py: 4 }}>
                      ...
                      <Grid container spacing={2}>
                        <Grid size={{ xs: 12, md: 6 }}>
                          <FileInput
                            ...
                            accept="image/*"
                            helperText={t('game_sections.image_helper')}
                          />
                          {game.image && (
                            <Box sx={{ mt: 2 }}>
                              <Typography variant="body2" sx={{ mb: 1, color: theme.palette.text.secondary }}>
                                {t('game_sections.selected_image')}
                              </Typography>
                              <Box
                                component="img"
